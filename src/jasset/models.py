...
class IDC(models.Model):
    ...
    operator = models.CharField(max_length=32, blank=True, null=True, default='', verbose_name=u'运营商')
    comment = models.CharField(max_length=128, blank=True, null=True, default='', verbose_name=u'备注')
...
class Asset(models.Model):
    ...
    hostname = models.CharField(max_length=128, unique=True, verbose_name=u'主机名称')
    ...
    user_default_auth = models.BooleanField(default=True, verbose_name=u'使用默认管理账号')
    ...
    system_arch = models.CharField(max_length=16, blank=True, null=True, verbose_name=u'系统架构')
    ...
    status = models.IntegerField(choices=ASSET_STATUS, blank=True, null=True, default=1, verbose_name=u'资产状态')
    asset_type = models.IntegerField(choices=ASSET_TYPE, blank=True, null=True, verbose_name=u'机器类型')
